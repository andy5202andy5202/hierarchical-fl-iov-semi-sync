...
INPUT_PATH = "./cifar_noniid_9groups_split"    
OUTPUT_PATH = "./cifar_noniid_3groups_mixed"   
...
for new_group, old_groups in group_mapping.items():
    ...
    for old_group in old_groups:
        ...
        labels_array = np.array(group_content['labels'], dtype=np.int64)  
    ...
    print(f"→ 合併後 labels unique: {np.unique(merged_labels)}")  
